...
class BYOLTEGLIETest:
    def __init__(self):
        ...
        self.path_csv =  os.path.join(usr,'data/BGcut_TEGLIE_subsample_small.csv')
    ...
    def generate_clean_name(self, preprocessing_steps, var, scaler):
        ...
        return f'bb_features&labels_prepbefore_[{preprocessing_str}]_PCA_var_{var}_scaler_{scaler}.npz'
    ...
    def initialize_augmentations(self):
        ...
        augment_fn = torch.nn.Sequential(
                ...
                kornia.augmentation.RandomGaussianBlur(kernel_size = [3,3],sigma = [1,2], p =self.g_p) )
...
if __name__ == "__main__":
    ...
    byol_test.run_feature_extractor(preprocessing_after_byol = preprocessing_after_byol, variance_threshold=0.95)
